...
public class CreationCandidatureViewModel extends ViewModel {

    CandidatureRepository candidatureRepository = new CandidatureRepository();


    public LiveData<Boolean> addCandidature(String offreID, String userID, String titreOffre, String prenom, String nom, String nationality, String date, String lettreDeMotivation) {
        Map<String, Object> candidature = new HashMap<>();
        candidature.put("userID", userID);
        candidature.put("offerID", offreID);
        candidature.put("offerTitle", titreOffre);
